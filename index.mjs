// Bank of Zambia exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/boz';
...
/** Latest rate for one pair, e.g. getRate('USD', 'ZMW', { apiKey }). */
